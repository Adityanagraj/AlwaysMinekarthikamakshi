...
//! yes - Music Importing
import yesmusic1 from "./assets/AudioTracks/1.mp3";
import yesmusic2 from "./assets/AudioTracks/2.mp3";
import yesmusic3 from "./assets/AudioTracks/3.mp3";
...
//! no - Music Importing
import nomusic1 from "./assets/AudioTracks/1.mp3";
import nomusic2 from "./assets/AudioTracks/2.mp3";
import nomusic3 from "./assets/AudioTracks/3.mp3";
...
export default function Page() {
  ...
  const handleNoClick = () => {
    ...
    if (nextCount === 1 || (nextCount - 1) % 4 === 0) {
      const nextSongIndex = Math.floor(nextCount / 4) % NoMusic.length;
  ...
  useEffect(() => {
    if (yesPressed && noCount < 4 && !popupShown) {
      Swal.fire({
        title: "I love you sooo Much!!!❤️, You’ve stolen my heart completely!!! 🥰💖Love you so much! 🥰✨",
        showClass: {
          popup: `
            animate__animated
            animate__fadeInUp
        ...
        {yesPressed && noCount>3 ? (
          ...
          <>
            ...
            <h1 className="text-4xl md:text-6xl my-4 text-center">
              Will you be my Valentine Kamakshi?
            </h1>
